...
namespace Consul
{
    ...
    public interface IPolicyEndpoint
    {
        ...
        Task<QueryResult<TemplatedPolicyResponse>> ReadATemplatedPolicyByName(string name, QueryOptions q, CancellationToken ct = default);
        Task<QueryResult<TemplatedPolicyResponse>> ReadATemplatedPolicyByName(string name, CancellationToken ct = default);
    }
}
