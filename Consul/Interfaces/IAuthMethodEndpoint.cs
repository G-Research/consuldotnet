// -----------------------------------------------------------------------
//  <copyright file="IAuthMethodEndpoint.cs" company="G-Research Limited">
...
namespace Consul
{
    ...
    public interface IAuthMethodEndpoint
    {
        ...
        Task<WriteResult<TokenEntry>> Login(string authMethod, string bearerToken, WriteOptions q, CancellationToken ct = default);
