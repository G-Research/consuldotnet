...
namespace Consul
{
    ...
    public interface ICatalogEndpoint
    {
        ...
        Task<QueryResult<Dictionary<string, string[]>>> Services(string dc, string filter, CancellationToken ct = default);
        Task<QueryResult<Dictionary<string, string[]>>> Services(string dc, string filter, QueryOptions q, CancellationToken ct = default);
