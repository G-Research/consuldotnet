...
namespace Consul
{
    ...
    public interface ICatalogEndpoint
    {
        ...
        Task<QueryResult<NodeService>> ServicesForNodes(string node, QueryOptions q, CancellationToken ct = default);
        Task<QueryResult<NodeService>> ServicesForNodes(string node, CancellationToken ct = default);
    }
}
