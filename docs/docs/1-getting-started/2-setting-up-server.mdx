...
2a. If using Windows, create a file called test_config.json in the Consul.Test folder, containing something like this:
```
{
  "datacenter": "east-aws",
  "data_dir": "C:\\Consul.Test",
  "log_level": "INFO",
  "node_name": "foobar",
  "server": true,
  "bind_addr": "127.0.0.1",
  "bootstrap": true,
  "ui": true,
  "log_file" : "C:\\Consul.Test\\consul.log" 
}
```
