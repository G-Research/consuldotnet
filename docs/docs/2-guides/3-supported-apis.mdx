...
|                                 | Create Intention with ID                                | POST v1/connect/intentions                     | 🛑 (Deprecated in 1.10.0) |
|                                 | Update Intention by ID                                  | PUT v1/connect/intentions/:uuid                | 🛑 (Deprecated in 1.10.0) |
|                                 | Read Specific Intention by Name                         | GET v1/connect/intentions/exact                | ✅                        |
|                                 | Read Specific Intention by ID                           | GET v1/connect/intentions/:uuid                | 🛑 (Deprecated in 1.10.0) |
|                                 | List Intentions                                         | GET v1/connect/intentions                      | ✅                        |
|                                 | Delete Intention by Name                                | DELETE v1/connect/intentions/exact             | ✅                        |
|                                 | Delete Intention by ID                                  | DELETE v1/connect/intentions/:uuid             | 🛑 (Deprecated in 1.10.0) |
