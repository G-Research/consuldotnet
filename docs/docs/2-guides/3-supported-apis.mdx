...
_The table below shows which endpoints are currently supported._
...
| **ACL-Legacy**                  | Create ACL Token                                        | PUT v1/acl/create                              | 🛑 (Deprecated)           |
|                                 | Update ACL Token                                        | PUT v1/acl/update                              | 🛑 (Deprecated)           |
|                                 | Destroy ACL Token                                       | PUT v1/acl/destroy/:id                         | 🛑 (Deprecated)           |
|                                 | Read ACL Token                                          | GET v1/acl/info/:id                            | 🛑 (Deprecated)           |
|                                 | Clone ACL Token                                         | PUT v1/acl/clone/:id                           | 🛑 (Deprecated)           |
|                                 | List ACL Tokens                                         | GET v1/acl/list                                | 🛑 (Deprecated)           |
|                                 | Translate Rules                                         | POST v1/acl/rules/translate                    | 🛑 (Deprecated)           |
|                                 | Translate a Legacy Token's Rules                        | GET v1/acl/rules/translate/:id                 | 🛑 (Deprecated)           |
