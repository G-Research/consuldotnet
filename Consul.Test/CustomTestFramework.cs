...
namespace Consul.Test
{
    public class CustomTestFramework : XunitTestFramework
    {
        ...
        {
            public CustomExecutor(AssemblyName assemblyName, ISourceInformationProvider sourceInformationProvider,
        ...
        {
            public CustomAssemblyRunner(ITestAssembly testAssembly, IEnumerable<IXunitTestCase> testCases,
            ...
            protected override Task<RunSummary> RunTestCollectionAsync(IMessageBus messageBus,
                ...
                => new CustomTestCollectionRunner(testCollection, testCases, DiagnosticMessageSink, messageBus,
        ...
        {
            public CustomTestCollectionRunner(ITestCollection testCollection, IEnumerable<IXunitTestCase> testCases,
            ...
            protected override Task<RunSummary> RunTestClassAsync(ITestClass testClass, IReflectionTypeInfo @class,
                ...
                => new CustomTestClassRunner(testClass, @class, testCases, DiagnosticMessageSink, MessageBus,
        ...
        {
            public CustomTestClassRunner(ITestClass testClass, IReflectionTypeInfo @class,
            ...
            protected override Task<RunSummary> RunTestMethodAsync(ITestMethod testMethod, IReflectionMethodInfo method,
                ...
                => new CustomTestMethodRunner(testMethod, this.Class, method, testCases, this.DiagnosticMessageSink,
                        this.MessageBus, new ExceptionAggregator(this.Aggregator), this.CancellationTokenSource,
        ...
        private class CustomTestMethodRunner : XunitTestMethodRunner
        {
            ...
            public CustomTestMethodRunner(ITestMethod testMethod, IReflectionTypeInfo @class,
