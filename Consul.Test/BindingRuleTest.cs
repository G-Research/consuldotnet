...
namespace Consul.Test
{
    public class BindingRuleTest : BaseFixture
    {
        ...
        public async Task BindingRule_Create()
        {
            var authMethodEntry = new AuthMethodEntry
            {
                ...
                Config = new Dictionary<string, string>
                {
                    ...
                    ["ServiceAccountJWT"] = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNzA4MzQ1MTIzLCJleHAiOjE3MDgzNTUxMjN9.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c"
                }
            };
        ...
        {
            var cutOffVersion = SemanticVersion.Parse("1.5.0");
            Skip.If(AgentVersion < cutOffVersion, $"Current version is {AgentVersion}, but Binding rules are only supported from Consul {cutOffVersion}");
